window.onload = function() {
    ...
    // Show lives
    comments = function() {
        showLives.innerHTML = "Tu tienes " + lives + " vidas";
        if (lives < 1) {
    ...
    hint.onclick = function() {
    	hints = ["Northern city in the UK", "Home of AC and Inter", "Spanish capital", "Netherlands capital", "Czech Republic capital"];
        /*hints = [
